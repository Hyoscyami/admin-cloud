...
--
-- Host: 127.0.0.1    Database: id_generate
-- ------------------------------------------------------
...
--
-- Table structure for table `segment_alloc`
--

DROP TABLE IF EXISTS `segment_alloc`;
/*!40101 SET @saved_cs_client = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `segment_alloc`
(
    `id`            bigint unsigned                                              NOT NULL COMMENT '主键',
    `biz_tag`       varchar(128) COLLATE utf8mb4_0900_ai_ci                      NOT NULL COMMENT '业务标识',
    ...
    UNIQUE KEY `segment_alloc_biz_tag_uindex` (`biz_tag`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci
  ROW_FORMAT = DYNAMIC COMMENT ='号段模式id分配表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `segment_alloc`
--

LOCK TABLES `segment_alloc` WRITE;
/*!40000 ALTER TABLE `segment_alloc`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `segment_alloc`
    ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-01-11 14:47:37
